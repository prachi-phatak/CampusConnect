...
function SectionEyebrow({ children }: { children: React.ReactNode }) {
  return (
    <p className="eyebrow flex items-center gap-2 font-bold" style={{ letterSpacing: "0.1em", fontSize: "12px" }}>
      <Sparkle size={10} />
      {children}
    </p>
  );
    ...
    <SiteShell>
      ...
      <section className="relative border-b-2 border-black bg-lime px-4 py-28 md:px-6 md:py-36">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-8 max-w-[640px] font-mono text-sm leading-relaxed md:text-base">
            CampusConnect is the open-source operating system for college clubs and tech
            communities. Run events, grow membership, ship certificates — without the
            spreadsheet chaos.
          </p>
      ...
      <section className="border-b-2 border-black bg-cream px-4 py-20 md:px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              { n: "01", tone: "bg-lime", t: "Clubs first", d: "Every club gets a home page, member roster, and event calendar — no more Google Docs bureaucracy." },
              { n: "02", tone: "bg-sky", t: "Events that ship", d: "RSVPs, check-ins, feedback, and post-event reports in one flow. Nothing lost to Instagram DMs." },
              { n: "03", tone: "bg-peach", t: "Proof of work", d: "Auto-issued certificates and portable member profiles for hackathons, workshops, and volunteer hours." },
            ].map((c) => (
              <article key={c.n} className="neu-border neu-press bg-white p-6">
                <div className={`neu-border ${c.tone} mb-4 inline-block px-3 py-1 font-mono text-sm font-bold`}>{c.n}</div>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-md font-mono text-sm leading-relaxed">
              CampusConnect collapses the tools clubs juggle — forms, spreadsheets, chat,
              posters, email — into one workflow that respects your time.
            </p>
          </div>
              ...
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <span className="mt-1 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 border-black bg-black text-cream">
                    <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="4"><path d="M4 12l6 6L20 6" /></svg>
                  </span>
      ...
      <section className="border-b-2 border-black bg-peach px-4 py-20 md:px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              { t: "Handoff hell", d: "Every year, club leadership rotates and half the knowledge dies in a personal Notion." },
              { t: "Data locked in DMs", d: "Attendance in a WhatsApp group, RSVPs in a form, feedback nowhere. Never joined up." },
              { t: "No proof, no trust", d: "Members do real work but leave with nothing verifiable to show recruiters." },
            ].map((c) => (
      ...
      <section className="border-b-2 border-black bg-sky px-4 py-20 md:px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              { t: "vs. Google Forms + Sheets", d: "Great for one event. Falls apart across a year, across clubs, across handoffs." },
              { t: "vs. Discord / WhatsApp", d: "Perfect for chatter. Not designed to be a source of truth for membership or attendance." },
              { t: "vs. Eventbrite / Luma", d: "Solid for the general public. Doesn't understand semesters, clubs, or student verification." },
              { t: "vs. Custom college portals", d: "Locked to one campus, no interop, no open-source community driving improvements." },
            ].map((c) => (
      ...
      <section className="border-b-2 border-black bg-lavender px-4 py-20 md:px-6">
        <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-2">
          <div>
            ...
            <h2 className="text-4xl font-bold md:text-5xl">Hosted or self-hosted. Same features either way.</h2>
            <p className="mt-6 font-mono text-sm leading-relaxed">
              Grab the managed cloud instance and start today, or fork the repo and deploy
              on your college's infra. The core is MIT-licensed and hackable to the bone.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="neu-border bg-lime p-5">
              ...
              <p className="mt-3 font-mono text-xs leading-relaxed">Managed hosting, SSO with your college email, zero devops.</p>
            </div>
            <div className="neu-border bg-white p-5">
              ...
              <p className="mt-3 font-mono text-xs leading-relaxed">Docker compose up. Own the database, own the data.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-b-2 border-black bg-lime px-4 py-20 md:px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <h2 className="mb-12 max-w-2xl text-4xl font-bold md:text-5xl">Plays nice with the tools you already use.</h2>
          <div className="grid gap-6 md:grid-cols-2">
            {[
              { t: "Google Calendar", d: "Publish once, sync everywhere. Members subscribe to a club's ical feed." },
              { t: "Discord + Slack", d: "Auto-post event announcements, ping RSVPs, close the loop with reminders." },
              { t: "GitHub", d: "Link hackathon submissions and workshop repos directly to member profiles." },
              { t: "Zapier / Webhooks", d: "Every action fires a webhook. Wire it into whatever weird workflow you love." },
            ].map((c) => (
              <article key={c.t} className="neu-border neu-press bg-white p-6">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <article className="neu-border bg-white p-6">
              <span className="neu-border bg-peach px-2 py-1 font-mono text-xs font-bold uppercase">Rate limited</span>
              <h3 className="mt-4 mb-2 text-xl font-bold">Certificate generation</h3>
              <p className="font-mono text-sm leading-relaxed">Bulk certificate jobs are throttled to 200/min on the shared cloud tier. Self-host to lift the cap.</p>
            </article>
            <article className="neu-border bg-white p-6">
              <span className="neu-border bg-lime px-2 py-1 font-mono text-xs font-bold uppercase">In progress</span>
              <h3 className="mt-4 mb-2 text-xl font-bold">Mobile check-in app</h3>
              <p className="font-mono text-sm leading-relaxed">Native iOS/Android app for door-scanning is in alpha. PWA works today.</p>
            </article>
          </div>
        </div>
      </section>
